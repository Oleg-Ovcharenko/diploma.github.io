...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Provider__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connectAdvanced__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(41);
...
exports.addNetworkWindowSize = addNetworkWindowSize;
exports.generateNodes = generateNodes;
var ADD_NETWORK_WINDOW_SIZES = exports.ADD_NETWORK_WINDOW_SIZES = 'ADD_NETWORK_WINDOW_SIZES';
function addNetworkWindowSize(width, height) {
    return {
...
var GENERATE_NODES = exports.GENERATE_NODES = 'GENERATE_NODES';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(40);
...
var NODE_COLOR = exports.NODE_COLOR = '#007bff';
...
var reduxDevTools = window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(); /* global window */

var store = (0, _redux.createStore)(_reducers2.default, _store2.default, reduxDevTools);

(0, _reactDom.render)(_react2.default.createElement(
    _reactRedux.Provider,
    { store: store },
    _react2.default.createElement(_App2.default, { dispatch: store.dispatch })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(43);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(19), __webpack_require__(53)(module)))
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(24),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(25),da=__webpack_require__(26),ea=__webpack_require__(27),fa=__webpack_require__(28),ia=__webpack_require__(29),D=__webpack_require__(6);
...
var _MainLayout = __webpack_require__(78);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'main',
                    { className: 'app-main' },
                    _react2.default.createElement(_SideBar2.default, { dispatch: dispatch }),
                    _react2.default.createElement(_MainLayout2.default, { dispatch: dispatch })
                )
            );
        }
    }]);
...
var _Controls = __webpack_require__(74);
    ...
    _createClass(SideBar, [{
        ...
        value: function render() {
            var _props = this.props,
                networkPanelWidth = _props.networkPanelWidth,
                networkPanelHeight = _props.networkPanelHeight,
...
SideBar.propTypes = {
    networkPanelWidth: _propTypes2.default.number,
    networkPanelHeight: _propTypes2.default.number
};
...
var _CardMenu = __webpack_require__(76);

var _CardMenu2 = _interopRequireDefault(_CardMenu);

var _actions = __webpack_require__(13);

var _helpersFunctions = __webpack_require__(77);
...
var Controls = function (_React$Component) {
    ...
    _createClass(Controls, [{
        ...
        value: function handleNodes(e) {
            var nodesValue = e.target.value.match(/\d+/g).map(Number);
        ...
        value: function handleGenerate(e) {
            ...
            var nodes = [];
            var nodeSizePercentX = _constants.NODE_RADIUS * 100 / networkPanelWidth;
            var nodeSizePercentY = _constants.NODE_RADIUS * 100 / networkPanelHeight;

            for (var i = 0; i < nodesValue; i += 1) {
                var node = {
                    id: i + 1,
                    x: (0, _helpersFunctions.randomFloatRange)(nodeSizePercentX, 100 - nodeSizePercentX),
                    y: (0, _helpersFunctions.randomFloatRange)(nodeSizePercentY, 100 - nodeSizePercentY),
                    params: {}
                };
            ...
            this.props.dispatch((0, _actions.generateNodes)(nodes));
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h6',
                    { className: 'text-center text-muted m-b-1-rem' },
                    'Generate some nodes'
                ),
                _react2.default.createElement(
                    'form',
...
var CardMenu = function CardMenu(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'card custom-card b-r-0' },
        _react2.default.createElement(
            'div',
...
var randomFloatRange = exports.randomFloatRange = function randomFloatRange(min, max) {
...
var _ControlsNetwork = __webpack_require__(79);

var _ControlsNetwork2 = _interopRequireDefault(_ControlsNetwork);

var _Network = __webpack_require__(80);
...
var MainLayout = function (_Component) {
    ...
    _createClass(MainLayout, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'section',
                { className: 'main-layout p-1-25' },
                _react2.default.createElement(_ControlsNetwork2.default, null),
                _react2.default.createElement(_Network2.default, {
                    nodes: nodes,
                    dispatch: dispatch
                })
            );
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(MainLayout);
...
var ControlsNetwork = function (_Component) {
    _inherits(ControlsNetwork, _Component);

    function ControlsNetwork() {
        _classCallCheck(this, ControlsNetwork);

        return _possibleConstructorReturn(this, (ControlsNetwork.__proto__ || Object.getPrototypeOf(ControlsNetwork)).apply(this, arguments));
    }

    _createClass(ControlsNetwork, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "card m-b-1-25 control-networks b-r-0" },
                _react2.default.createElement(
                    "div",
                    { className: "card-body d-flex align-i-center b-r-0" },
                    _react2.default.createElement(
                        "button",
    ...
    return ControlsNetwork;
}(_react.Component);

exports.default = ControlsNetwork;
...
var Network = function (_Component) {
    ...
    function Network(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Network.__proto__ || Object.getPrototypeOf(Network)).call(this, props));

        _this.setSvgSizes = function () {
            var _this$bodyRef$getBoun = _this.bodyRef.getBoundingClientRect(),
                width = _this$bodyRef$getBoun.width,
                height = _this$bodyRef$getBoun.height;

            console.log(height);

            _this.props.dispatch((0, _actions.addNetworkWindowSize)(width, height));
        ...
        _this.getNetworkBodyRef = function (ref) {
            _this.bodyRef = ref;
        };

        _this.reszeWindow = function () {
            _this.setSvgSizes();
        };
    ...
    _createClass(Network, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'card network-layout b-r-0' },
                _react2.default.createElement(
                    'div',
                    { className: 'card-body p-0 w-100 h-100', ref: this.getNetworkBodyRef },
                    _react2.default.createElement(
                        'svg',
                        { viewBox: viewBox, version: '1.1', xmlns: 'http://www.w3.org/2000/svg', width: '100%', height: '100%' },
                        ...
                        _react2.default.createElement(
                            ...
                            nodes.map(function (node) {
                                return _react2.default.createElement(
                                    'circle',
                                    { key: node.id, cx: node.x + '%', cy: node.y + '%', r: _constants.NODE_RADIUS, fill: _constants.NODE_COLOR },
                                    _react2.default.createElement(
                                        'title',
                                        null,
                                        'NODE ' + node
...
function reducer() {
    ...
    switch (action.type) {
        case _actions.ADD_NETWORK_WINDOW_SIZES:
            {
                var ui = {
                    ui: {
                        networkPanel: {
                ...
                return _extends({}, state, ui);
            }

        case _actions.GENERATE_NODES:
            {
                var nodes = {
                    nodes: action.nodes
                };

                return _extends({}, state, nodes);
            }
        default:
            return state;
    }
